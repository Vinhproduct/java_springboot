...
import com.nguyenvanvinh.example05.repository.ProductRepo;
import com.nguyenvanvinh.example05.service.CartService;
import com.nguyenvanvinh.example05.service.FileService;
...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductDTO getProductById(Long productId) {
        ...
        if (productOptional.isPresent()) {
            ...
            productDTO.setCategoryName(product.getCategory().getCategoryName()); // Set categoryName
            return productDTO;
        } else {
