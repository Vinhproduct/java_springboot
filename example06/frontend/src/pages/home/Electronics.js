        ...
        <div className="row no-gutters">
          <div className="col-md-3">
            <div className="home-category-banner bg-light-orange">
              ...
              <img src={require("../../assets/images/items/14.jpg")} className="img-bg" alt="Banner" />
            </div>
          </div> {/* col.// */}
            ...
            <ul className="row no-gutters bordered-cols">
              <li className="col-6 col-lg-3 col-md-4">
                <a href="#" className="item">
                  <div className="card-body">
                    ...
                    <img className="img-sm float-right" src={require("../../assets/images/items/7.jpg")} alt="Item" />
              ...
              <li className="col-6 col-lg-3 col-md-4">
                <a href="#" className="item">
                  <div className="card-body">
                    ...
                    <img className="img-sm float-right" src={require("../../assets/images/items/8.jpg" )}alt="Item" />
              ...
              <li className="col-6 col-lg-3 col-md-4">
                <a href="#" className="item">
                  <div className="card-body">
                    ...
                    <img className="img-sm float-right" src={require("../../assets/images/items/9.jpg")} alt="Item" />
              ...
              <li className="col-6 col-lg-3 col-md-4">
                <a href="#" className="item">
                  <div className="card-body">
                    ...
                    <img className="img-sm float-right" src={require("../../assets/images/items/10.jpg")} alt="Item" />
              ...
              <li className="col-6 col-lg-3 col-md-4">
                <a href="#" className="item">
                  <div className="card-body">
                    <h6 className="title">Home and kitchen electronic stuff collection</h6>
                    <img className="img-sm float-right" src={require("../../assets/images/items/11.jpg")} alt="Item" />
                    <p className="text-muted"><i className="fa fa-map-marker-alt"></i> Guanjou, China</p>
                  </div>
                </a>
              </li>
              <li className="col-6 col-lg-3 col-md-4">
                <a href="#" className="item">
                  <div className="card-body">
                    <h6 className="title">Home and kitchen electronic stuff collection</h6>
                    <img className="img-sm float-right" src={require("../../assets/images/items/12.jpg")} alt="Item" />
                    <p className="text-muted"><i className="fa fa-map-marker-alt"></i> Guanjou, China</p>
                  </div>
                </a>
              </li>
              <li className="col-6 col-lg-3 col-md-4">
                <a href="#" className="item">
                  <div className="card-body">
                    <h6 className="title">Home and kitchen electronic stuff collection</h6>
                    <img className="img-sm float-right" src={require("../../assets/images/items/1.jpg")} alt="Item" />
                    <p className="text-muted"><i className="fa fa-map-marker-alt"></i> Guanjou, China</p>
                  </div>
                </a>
              </li>
              <li className="col-6 col-lg-3 col-md-4">
                <a href="#" className="item">
                  <div className="card-body">
                    <h6 className="title">Home and kitchen electronic stuff collection</h6>
                    <img className="img-sm float-right" src={require("../../assets/images/items/2.jpg")} alt="Item" />
                    <p className="text-muted"><i className="fa fa-map-marker-alt"></i> Guanjou, China</p>
                  </div>
                </a>
              </li>
