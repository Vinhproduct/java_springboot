            ...
            <div className="row no-gutters">
                <div className="col-md-3">
                    <div className="home-category-banner bg-light-orange">
                        ...
                        <img src={require("../../assets/images/items/2.jpg")} className="img-bg" alt="Banner" />
                    </div>
                </div> {/* col.// */}
                    ...
                    <ul className="row no-gutters bordered-cols">
                        ...
                        <li className="col-6 col-lg-3 col-md-4">
                            <a href="#" className="item">
                                <div className="card-body">
                                    ...
                                    <img className="img-sm float-right" src={require("../../assets/images/items/3.jpg")} alt="Item" />
                        ...
                        <li className="col-6 col-lg-3 col-md-4">
                            <a href="#" className="item">
                                <div className="card-body">
                                    ...
                                    <img className="img-sm float-right" src={require("../../assets/images/items/4.jpg")} alt="Item" />
                        ...
                        <li className="col-6 col-lg-3 col-md-4">
                            <a href="#" className="item">
                                <div className="card-body">
                                    <h6 className="title">Home and kitchen electronic stuff collection</h6>
                                    <img className="img-sm float-right" src={require("../../assets/images/items/5.jpg")} alt="Item" />
                        ...
                        <li className="col-6 col-lg-3 col-md-4">
                            <a href="#" className="item">
                                <div className="card-body">
                                    <h6 className="title">Home and kitchen electronic stuff collection</h6>
                                    <img className="img-sm float-right" src={require("../../assets/images/items/6.jpg")} alt="Item" />
                                    <p className="text-muted"><i className="fa fa-map-marker-alt"></i> Guanjou, China</p>
                                </div>
                            </a>
                        </li>
